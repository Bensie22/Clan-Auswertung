...
def generate_html_report(
    ...
    for _, row in df_active.iterrows():
        ...
        if name in strikes_data.get("demoted_this_week", []):
            strike_badge = " <span class='custom-tooltip align-left' style='font-size: 0.9em;'>❌ 3/3<span class='tooltip-text'>Wurde degradiert! Bewährungschance aktiv.</span></span>"
        elif name in strikes_data.get("kicked_this_week", []):
            strike_badge = " <span class='custom-tooltip align-left' style='font-size: 0.9em;'>❌ 3/3<span class='tooltip-text'>3 Verwarnungen: Verabschiedung!</span></span>"
        elif strike_val > 0:
